...
class EditDataScreen extends StatefulWidget {
  ...
  const EditDataScreen({super.key, required this.siswa});
...
class _EditDataScreenState extends State<EditDataScreen> {
  final FormDataController formCtrl = FormDataController();
  final AlamatController alamatCtrl = AlamatController();
  final StudentController studentCtrl = StudentController();
  ...
  void _fillForm() {
    ...
    formCtrl.nisn.text = s.nisn;
    formCtrl.namaLengkap.text = s.namaLengkap;
    formCtrl.jenisKelamin = s.jenisKelamin;
    formCtrl.agama = s.agama;
    formCtrl.tanggalLahirTerpilih = s.tanggalLahir;
    formCtrl.tempat.text = s.tempat;
    formCtrl.tanggalLahir.text = DateFormat(
      'yyyy-MM-dd',
    ).format(s.tanggalLahir);
    formCtrl.noTelepon.text = s.noTelepon;
    formCtrl.nik.text = s.nik;
    formCtrl.jalan.text = s.jalan!;
    formCtrl.rt.text = s.rt!;
    formCtrl.rw.text = s.rw!;
    formCtrl.namaAyah.text = s.namaAyah;
    formCtrl.namaIbu.text = s.namaIbu;
    formCtrl.namaWali.text = s.namaWali!;
    formCtrl.jalanOrtu.text = s.jalanOrtu;
    formCtrl.rtOrtu.text = s.rtOrtu;
    formCtrl.rwOrtu.text = s.rwOrtu;
    formCtrl.dusun.text = ''; // bisa fetch berdasarkan alamatId
    formCtrl.desa.text = '';
    formCtrl.kecamatan.text = '';
    formCtrl.kabupaten.text = '';
    formCtrl.provinsi.text = '';
    formCtrl.kodePos.text = '';
    formCtrl.dusunOrtu.text = '';
    formCtrl.desaOrtu.text = '';
    formCtrl.kecamatanOrtu.text = '';
    formCtrl.kabupatenOrtu.text = '';
    formCtrl.provinsiOrtu.text = '';
    formCtrl.kodePosOrtu.text = '';
  }
  ...
  Future<void> _pickTanggal() async {
    ...
    final picked = await showDatePicker(
      context: context,
      initialDate: formCtrl.tanggalLahirTerpilih ?? DateTime(now.year - 16),
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final updated = Siswa(
        ...
        namaLengkap: formCtrl.namaLengkap.text.trim(),
        ...
        alamatId: alamatId,
        namaAyah: formCtrl.namaAyah.text.trim(),
        namaIbu: formCtrl.namaIbu.text.trim(),
        namaWali: formCtrl.namaWali.text.trim(),
      ...
      final ok = await showDialog<bool>(
        ...
        builder: (c) => AlertDialog(
          ...
          content: const Text('Update data siswa?'),
          actions: [
            TextButton(
      ...
      await studentCtrl.updateStudent(widget.siswa.id!, updated);
                        ...
                        children: [
                          ...
                          TypeAheadField<Alamat>(
                            ...
                            suggestionsCallback: (pattern) async {
                              print("Cari dusun: $pattern");
                              try {
                                final list = await alamatCtrl.searchDusun(
                                  pattern,
                                );
                                print(
                                  "Supabase hasil: ${list.map((e) => e.dusun).toList()}",
                                );
                                return list;
                              } catch (e) {
                                return <Alamat>[];
                            ...
                            onSelected: (suggestion) {
                              ...
                              formCtrl.dusun.text = suggestion.dusun ?? '';
                            },
